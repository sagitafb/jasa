...
var mytext = getUrlParam('go','no_value');


// Matikan iklan GoogleAdsense saat tidak ada link
if (mytext == "no_value"){var adsense_link = ""; }
...
_("bawahnih").innerHTML = '<p><a href="'+mytext+'" rel="nofollow noopener" target="_blank" class="btnBlock btnBlocks">Go To Links (klik)</a></p>';
}
...
var mytext = getUrlParam('go','no_value'); //url
