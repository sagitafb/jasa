...
_("demo").innerHTML = '<p style="color:red">Selesai, Scroll perlahan kebawah dan klik tombol &quot;Download Now&quot; warna hijau dibawah ya</p>';
...
var mytext = getUrlParam('utm_source','no_value').replace("?utm_source=","").replace("GEA3","==").replace("GEA2","=");
var mytext = mytext.replace("android-app://org.telegram.messenger","").replace("https://t.me/","");
var mytext = mytext.replace("RYAN3","==").replace("RYAN2","=");
...
window.addEventListener?window.addEventListener("load",RyanWikwiks,!1):window.attachEvent?window.attachEvent("onload",RyanWikwiks):window.onload=RyanWikwiks;
