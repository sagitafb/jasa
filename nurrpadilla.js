...
window.addEventListener?window.addEventListener("load",NurrPadilla(mytext),!1):window.attachEvent?window.attachEvent("onload",NurrPadilla(mytext)):window.onload=NurrPadilla(mytext);
